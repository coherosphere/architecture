...
Keine auffälligen Mehrfachverwendungen.
...
- Ergänze fehlende Dateien im Manifest _oder_ lösche Manifest.md, wenn Docusaurus die Diagramme dynamisch indexiert.
- Für Hot-Spot-Namen (mehrere Ebenen) eine zentrale Namensquelle (YAML) führen, die von Diagramm-Generatoren verwendet wird.
- Stelle sicher, dass jede C3-Komponente mindestens eine C4-Sequence-Referenz besitzt (Design- oder Betriebsflow).
